      ...
      <div className={`w-full max-w-lg p-8 rounded-lg shadow-lg ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
        ...
        <div className="mb-6">
          <div className="flex border-b border-gray-200 dark:border-gray-700">
            ...
            <button
              className={`py-2 px-4 font-medium ${activeTab === 'countdown' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-500 dark:text-gray-400'}`}
          ...
          <div className="mt-4">
            ...
            {activeTab === 'countdown' && (
              <>
                <p className="mb-4">
                  Hitung mundur waktu ke momen spesial Anda.
                </p>
                <CountdownTimer isDarkMode={darkMode} />
              </>
            )}
          </div>
        </div>
